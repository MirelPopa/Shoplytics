from db.utils import generate_fake_sales, generate_fake_products
from db.models import SalesData, Product

def test_generate_fake_sales_creates_valid_data(test_db_session):
    generate_fake_products(n=3)
